    ...
    <>
      ...
      >
        <div className="container mx-auto">
          ...
          {/* Section 3 */}
          <section className=" tracking-tighter bg-white mb-10">
          ...
          <section className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-6">
              {milestones.map((item, i) => (
                <div
                  key={i}
                  className="p-5  border-2 border-gray-100 rounded-md hover:scale-110 transition-all duration-300 bg-white "
                >

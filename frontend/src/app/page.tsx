  ...
  return (
    ...
    <LoginModal isOpen={isLoginModalOpen} onClose={()=> setIsLoginModalOpen(false)}/>
      ...
      <VenomBeam className="w-full relative overflow-hidden p-10 container mx-auto lg:p-40  ">
        <div >
          <div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              {/* Content Section */}
              <div data-aos="fade-right" className="flex flex-col space-y-8 text-left">
                <div className="space-y-6">
                  ...
                  <p className="text-gray-700 leading-relaxed max-w-2xl tracking-tighter">
                    ...
                    materials, and personalized feedback to help you achieveyour
                    desired band score. Start your journey to global
                    opportunities today!
                  </p>
                </div>
        ...
        <main>
          {/*Benefit section*/}
          <section data-aos="fade-down" className="py-20 px-10 lg:px-40 tracking-tight">
                ...
                >
                  <div className="h-full text-center flex flex-col transition-shadow p-2">
                    ...
                    <div className="flex-1 flex flex-col justify-between ">
                      ...
                      <CardDescription className="font-medium leading-relaxed text-gray-600">
                        Receive detailed, actionable feedback on your writing
                        and speaking to identify areas for improvement.
                      </CardDescription>
                    </div>
                  </div>
                </SpotlightCard>
          ...
          <section data-aos = "fade-down" className="reason-section py-20 px-10 lg:px-20 tracking-tight">
            <div className="container mx-auto px-6 lg:px-8">
              {/*Heading*/}
              <div className="heading-holder text-center mb-16">
                ...
                <h5 className="text-[18px] font-normal text-gray-700 pt-[20px] tracking-tighter">
                  Our platform is engineered to deliver results, offering a
                  unique blend of comprehensive practice and personalized
                  support.
                </h5>
              </div>
              {/*Card holder*/}
              <div className="card-holder grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="hover:scale-105 transition-transform duration-300">
                  <SpotlightCard
                    spotlightColor="34, 211, 238"
                    className="h-full text-center flex flex-col rounded-md border-1 border-gray-100 shadow-sm hover:shadow-md transition-shadow p-6"
                  >
                    <div className="flex justify-center items-center mb-6">
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      <CardDescription className=" font-medium leading-relaxed text-gray-600">
                        ...
                        Each module is designed to mirror the actual IELTS exam
                        format, ensuring you are well-prepared for test day.
                      </CardDescription>
                    </div>
                  </SpotlightCard>
                </div>
                ...
                <div className="hover:scale-105 transition-transform duration-300">
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      <CardDescription className=" font-medium leading-relaxed text-gray-600">
                        Track your progress with detailed analytics that
                        highlight your strengths and pinpoint areas needing
                        improvement. Our intelligent system adapts to your
                        learning pace, offering tailored recommendations.
                      </CardDescription>
                    </div>
                  </SpotlightCard>
                </div>
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      <CardDescription className=" font-medium leading-relaxed text-gray-600">
                        ...
                        materials, grammar guides, vocabulary builders, and
                        proven strategies to maximize your score. Learn from the
                        best, at your own pace.
                      </CardDescription>
                    </div>
                  </SpotlightCard>
                </div>
          ...
          {/*Student's comments */}
          <section data-aos="fade-down" className="student-opinion-section mt-20 bg-gray-100 py-20 px-10 lg:px-30 tracking-tight">
            <div className="container ml-auto mr-auto lg:px-8">
              ...
              <div className="heading-holder text-center mb-16">
                ...
                <h5 className="text-[18px] font-normal text-gray-700 pt-[20px] tracking-tighter">
                  Hear what our successful students have to say about their
                  IELTS Sprint experience.
                </h5>
              </div>
              {/*Card Holder*/}
              <div className="card-holder grid lg:grid-cols-2 sm:grid-cols-1 gap-10">
                  ...
                  <Card className="h-full text-center flex flex-col gap-3 rounded-md border-1 border-gray-100 shadow-sm hover:shadow-lg hover:scale-105 transition-transform duration-300">
                    <div className="student-opinion px-10">
                      <p className="italic leading-relaxed font-medium">
                        ...
                        Band 8.0! The practice modules were incredibly
                        realistic, and the personalized feedback helped me
                        fine-tune my writing skills. Highly recommended for
                        anyone serious about their IELTS score.”
                      </p>
                    </div>
                    <br />
                ...
                <div>
                  <Card className="h-full text-center flex flex-col gap-3 rounded-md border-1 border-gray-100 shadow-sm hover:shadow-lg hover:scale-105 transition-transform duration-300">
                    <div className="student-opinion px-10">
                      <p className="italic leading-relaxed font-medium">
                        “As a working professional, time is precious. IELTS
                        Sprint allowed me to study efficiently with its
                        well-structured courses and flexible schedule. I
                        improved my score significantly and gained admission to
                        my desired program abroad.”
                      </p>
                    </div>
                    <br />
                    <div className="flex justify-center">
                  ...
                  <Card className="h-full text-center flex flex-col gap-3 rounded-md border-1 border-gray-100 shadow-sm hover:shadow-lg hover:scale-105 transition-transform duration-300">
                    <div className="student-opinion px-10">
                      <p className="italic leading-relaxed font-medium">
                        ...
                        helped me overcome my nervousness and speak confidently.
                        I scored Band 7.5 and am now ready for my immigration
                        journey!”
                      </p>
                    </div>
                    <br />
              ...
              <div className="flex-1">
                ...
                <div>
                  <p>
                    ...
                    exam. Our platform adapts to your learning style, providing

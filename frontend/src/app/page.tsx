  ...
  return (
    <>
      ...
      <main>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="h-full text-center flex flex-col transition-shadow p-2">
                  <div className="flex justify-center items-center mb-6">
                    <div className="w-16 h-16 flex items-center justify-center">
                      <FaBookOpen className="text-[#4b91e2] text-5xl" />
                    </div>
                  </div>
              ...
              >
                <div className="h-full text-center flex flex-col transition-shadow p-2">
                  <div className="flex justify-center items-center mb-6">
                    <div className="w-16 h-16 flex items-center justify-center">
                      <FaMedal className="text-[#4b91e2] text-5xl" />
                    </div>
                  </div>
                  <div className="flex-1 flex flex-col justify-between ">
                    <CardTitle className="text-2xl font-semibold mb-4 leading-tight text-gray-900">
              ...
              >
                <div className="h-full text-center flex flex-col transition-shadow p-2">
                  <div className="flex justify-center items-center mb-6">
                    <div className="w-16 h-16 flex items-center justify-center">
                      <IoPerson className="text-[#4b91e2] text-5xl" />
                    </div>
                  </div>
                  <div className="flex-1 flex flex-col justify-between ">
                    <CardTitle className="text-2xl font-semibold mb-4 leading-tight text-gray-900">
              ...
              >
                <div className="h-full text-center flex flex-col transition-shadow p-2">
                  <div className="flex justify-center items-center mb-6">
                    <div className="w-16 h-16 flex items-center justify-center">
                      <FaGraduationCap className="text-[#4b91e2] text-6xl" />
                    </div>
                  </div>
                  <div className="flex-1 flex flex-col justify-between ">
                    <CardTitle className="text-2xl font-semibold mb-4 leading-tight text-gray-900">
              ...
              >
                <div className="h-full text-center flex flex-col transition-shadow p-2">
                  <div className="flex justify-center items-center mb-6">
                    <div className="w-16 h-16 flex items-center justify-center">
                      <FaLightbulb className="text-[#4b91e2] text-5xl" />
                    </div>
                  </div>
                  <div className="flex-1 flex flex-col justify-between ">
                    <CardTitle className="text-2xl font-semibold mb-4 leading-tight text-gray-900">
        ...
        <section
          data-aos="fade-down"
          className="student-opinion-section mt-20 bg-gray-100 py-20 px-10 lg:px-30 tracking-tight"
        >

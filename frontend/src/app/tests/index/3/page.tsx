...
import { PaginationTest } from "@/components/ui/paginationtest";
...
export default function TestSamplePage() {
  ...
  return (
    <>
      ...
      <PaginationContent>
        <PaginationItem >
          <PaginationPrevious href="tests/index/2" size={100} className="text-blue-500 mr-3"/>
        </PaginationItem>
        <PaginationItem>
        ...
        <PaginationItem>
          <PaginationLink href="tests/index/3" isActive size={undefined} className="bg-blue-400 text-white">3</PaginationLink>
        </PaginationItem>
        <PaginationItem>
          <PaginationEllipsis />
        </PaginationItem>
        <PaginationItem>
          <PaginationNext href="tests/index/4" size={100} className="text-blue-500 ml-2"/>
        </PaginationItem>
      </PaginationContent>
    </Pagination>
      </footer>

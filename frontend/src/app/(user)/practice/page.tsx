    ...
    <>
      ...
      >
        <div className="container mx-auto">
            ...
            <div className="mb-1">
              ...
              <div className="mb-8">
                ...
                <p className="tracking-tight">
                  ...
                  materials, and <br /> personalized feedback to help you
                  achieve your desired band score. Start your <br /> journey to
          ...
          {/*Second section*/}
          <section className="py-10  mb-5 tracking-tighter">
